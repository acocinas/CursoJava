...
public class CrudHotel {
	public static void createHotel(ArrayList<Hotel> hoteles) {// Creamos los hoteles y los guardamos en el ArrayList
		String message = "", name = "";
		int rooms = 0, floors = 0, area = 0, position = 0;
		name = JOptionPane.showInputDialog("Nombre del hotel");
		position = find(hoteles, name);
		if (position == -1) {
	...
	public static void seeHotel(ArrayList<Hotel> hoteles) {// aquí usamos los getter para ver la info guardada del hotel
															// si existe
		String check = "";
		int position = 0;
		...
		if (position != -1) {
			...
			// esta línea nos dice que en esa posición del array, usamos el método de
			// mantenimiento para esa posición del array y que en esa posición
			// use ese número de habitaciones que son las guardadas en la misma posición
		} else {
			JOptionPane.showMessageDialog(null,
					"El hotel " + check + " no está en la aplicación, debe escribirse igual para ser encontrado");
		}
	}

	public static void modificationHotel(ArrayList<Hotel> hoteles) {// otro desplegable, para las modificaciones del
																	// hotel.
		...
		if (position != -1) {
			...
			if ("Modificar número de habitaciones".equals(modificationHotel)) {
				...
				JOptionPane.showMessageDialog(null,
						"Las habitaciones del hotel" + check + " han sido modificadas correctamente.");
				...
				JOptionPane.showMessageDialog(null,
						"Las plantas del hotel " + check + " han sido modificadas correctamente.");
				...
				JOptionPane.showMessageDialog(null,
						"El área del hotel " + check + " ha sido actualizado correctamente.");
			}
	...
	public static void removeHotel(ArrayList<Hotel> hoteles) {// en este método eliminamos el hotel en caso de existir.
		...
		if (position != -1) {
			...
			JOptionPane.showMessageDialog(null,
					"Ese hotel " + check + " no está en la aplicación, debe escribirse igual para ser encontrado.");
		}
	}
	...
	public static int find(ArrayList<Hotel> hoteles, String check) {// este método se usa en todos menos en el de crear
																	// hotel, para saber
